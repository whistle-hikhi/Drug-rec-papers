...
Also added on request: "Patients-like-me" (arXiv:2608.04193, Aug 2026) — a variational LM-GNN framework evaluated on MIMIC across four tasks including medication recommendation, explaining predictions via retrieved similar patients — filed in `01-ehr-based`. Collection is now ~146 papers. Not exhaustive — treat as a scaffold to keep extending as you read. See `NOTES.md` for what's thin and worth digging into next.
